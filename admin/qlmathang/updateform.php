...
<div>
	...
	<form method="post" action="index.php" enctype="multipart/form-data">
		...
		<div class="my-3">
			...
			<select class="form-control" name="optdanhmuc">
				<?php foreach ($danhmuc as $dm) { ?>
					<option value="<?php echo $dm["id"]; ?>" <?php if ($dm["id"] == $m["danhmuc_id"]) echo "selected"; ?>><?php echo $dm["tendongmay"]; ?></option>
				<?php } ?>
			</select>
		</div>
		<div class="my-3">
		...
		<div class="my-3">
			...
			<img src="../../images/product/<?php echo $m["hinhanh"]; ?>" width="50" class="img-thumbnail">
